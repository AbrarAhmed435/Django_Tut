...
def order_list(request):
    orders=Order.objects.prefetch_related('items__product').all() #items__product :product inside each order item
    # means :For every Order, also pull its related OrderItems and pull the Product referenced by each of those items.”
